exports.up = function(knex, Promise) {
  return knex.schema.raw(
    `
    alter view view_eat_log_type3 as
    select t1.*
    from
    (
      select eat_log_id, eat_log_member_id, eat_log_food_id, eat_log_recipe_id,
        ...
        round((food_carb*4 + food_protein*4 + food_fat*9)*eat_log_amount, 3) as kcal, food_unit as unit
      ...
      select eat_log_id, eat_log_member_id, eat_log_food_id, eat_log_recipe_id,
        ...
        round(((recipe_carb*4 + recipe_protein*4 + recipe_fat*9)/recipe_serving)*eat_log_serve, 3) as kcal, 'people' as unit

...
export const GET_SHORTLOG_FAILED =
  'GET_SHORTLOG_FAILED'
// shortLog POST
export const POST_SHORTLOG_REQUEST =
  'POST_SHORTLOG_REQUEST'
export const POST_SHORTLOG_SUCCESS =
  'POST_SHORTLOG_SUCCESS'
export const POST_SHORTLOG_FAILED =
  'POST_SHORTLOG_FAILED'
// shortLog UPDATE
export const UPDATE_SHORTLOG_REQUEST =
  'UPDATE_SHORTLOG_REQUEST'
export const UPDATE_SHORTLOG_SUCCESS =
  'UPDATE_SHORTLOG_SUCCESS'
export const UPDATE_SHORTLOG_FAILED =
  'UPDATE_SHORTLOG_FAILED'
// shortLog DELETE
...
export const GET_LONGLOG_SUCCESS =
  'GET_LONGLOG_SUCCESS'
export const GET_LONGLOG_FAILED =
  'GET_LONGLOG_FAILED'
//longLog POST
export const POST_LONGLOG_REQUEST =
  'POST_LONGLOG_REQUEST'
export const POST_LONGLOG_SUCCESS =
  'POST_LONGLOG_SUCCESS'
export const POST_LONGLOG_FAILED =
  'POST_LONGLOG_FAILED'
//longLog UPDATE
export const UPDATE_LONGLOG_REQUEST =
  'UPDATE_LONGLOG_REQUEST'
export const UPDATE_LONGLOG_SUCCESS =
  'UPDATE_LONGLOG_SUCCESS'
export const UPDATE_LONGLOG_FAILED =
  'UPDATE_LONGLOG_FAILED'
//longLog DELETE
